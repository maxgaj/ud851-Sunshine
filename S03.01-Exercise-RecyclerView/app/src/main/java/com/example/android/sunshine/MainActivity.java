...
public class MainActivity extends AppCompatActivity {
    ...
    private ForecastAdapter mForecastAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecastAdapater = new ForecastAdapter();

        // COMPLETED (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        mRecyclerView.setAdapter(mForecastAdapater);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                 ...
                 */
                mForecastAdapater.setWeatherData(weatherData);
            } else {
                showErrorMessage();
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mForecastAdapater.setWeatherData(null);
            loadWeatherData();
            return true;
        }
