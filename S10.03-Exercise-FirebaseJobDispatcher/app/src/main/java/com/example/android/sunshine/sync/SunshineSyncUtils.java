...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int DELAY_SECONDS = (int) TimeUnit.HOURS.toSeconds(DELAY_HOURS);
...
//  COMPLETED (12) Create a method to schedule our periodic weather sync
    static void scheduleSync(Context context){
        ...
        Job job = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(INTERVAL_SECONDS, INTERVAL_SECONDS+DELAY_SECONDS))
                .setTag(SYNC_TAG)
